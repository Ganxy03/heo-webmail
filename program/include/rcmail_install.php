...
class rcmail_install
{
    ...
    public function fail($name, $message = '', $url = '', $optional = false)
    {
        ...
        echo rcube::Q($name) . ':&nbsp; <span class="fail">不 OK</span>';
    ...
    {
        echo rcube::Q($name) . ':&nbsp; <span class="na">不 OK</span>';
        $this->_showhint($message, $url);
    }
    ...
    {
        echo rcube::Q($name) . ':&nbsp; <span class="na">非必要</span>';
        $this->_showhint($message, $url);
    }
    ...
    private function _showhint($message, $url = '')
    {
        ...
        if ($url) {
            $hint .= ($hint ? '; ' : '') . '详见 <a href="' . rcube::Q($url) . '" target="_blank">' . rcube::Q($url) . '</a>';
        }
